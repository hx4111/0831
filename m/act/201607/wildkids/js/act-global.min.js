...
var ControlPost = React.createClass({displayName: "ControlPost",
	...
	componentDidMount: function() {
		...
		$(window).scroll(function () {
			var toTopHeight = document.getElementById('post-and-Ctrl').offsetTop - $(window).height() - 50;
			if ($(window).scrollTop() > toTopHeight) {
				_self.setState({ctrlTopDisp: true});
			}
			if ($(window).scrollTop() < toTopHeight) {
				_self.setState({ctrlTopDisp: false});
			}
		})
	},
	...
	render: function() {
		return (
			React.createElement("div", {className: "ctrl-comp ctrl-post smart-tip-inst", style: {opacity: this.state.ctrlTopDisp ? 1 : 0}, onClick: this.toPost}, 
...
var ControlTop = React.createClass({displayName: "ControlTop",
	...
	render: function() {
		return (
			React.createElement("div", {className: "ctrl-comp ctrl-top", style: {opacity: this.state.ctrlTopDisp ? 1 : 0}, onClick: this.toTop}, 
...
var ControlBox = React.createClass({displayName: "ControlBox",
	render: function() {
		return (
			React.createElement("div", {className: "ctrl-container"}, 
		...
		if (!CONFIG.isApp) {
			EventEmitter.subscribe('makePostShow', function() {
				...
				if (comiUser) {
					...
					window.location.href = 'http://localhost:3002/login.html';//'http://m.comicool.cn/login.html'
				}
			})
		}
	},
