...
cc._supportRender=!0):cc._supportRender=!1}function b(a,c,d){if(h[c])return null;d=d||"";var e=[],f=a[c];if(!f)throw Error("can not find module ["+c+"]");c=cc.path;for(var g=0,m=f.length;g<m;g++){var k=f[g];if(!h[k]){var z=c.extname(k);z?".js"===z.toLowerCase()&&e.push(c.join(d,k)):(z=b(a,k,d))&&(e=e.concat(z));h[k]=1}}return e}function c(a){cc._initDebugSetting&&cc._initDebugSetting(a[cc.game.CONFIG_KEY.debugMode]);cc._engineLoaded=!0;cc.log(cc.ENGINE_VERSION);m&&m()}function d(a){var d=a[cc.game.CONFIG_KEY.engineDir],
e=cc.loader;if(cc.Class)c(a);else{var f=cc.path.join(d,"moduleConfig.json");e.loadJson(f,function(e,f){if(e)throw Error(e);var g=a.modules||[],h=f.module,m=[];cc.sys.capabilities.opengl&&0>g.indexOf("base4webgl")?g.splice(0,0,"base4webgl"):0>g.indexOf("core")&&g.splice(0,0,"core");for(var k=0,t=g.length;k<t;k++){var r=b(h,g[k],d);r&&(m=m.concat(r))}cc.loader.loadJsWithImg(m,function(b){if(b)throw b;c(a)})})}}function e(){this.removeEventListener("load",e,!1);d(cc.game.config)}var f=document.createElement("canvas"),
...
a.BROWSER_TYPE_SAFARI="safari";a.BROWSER_TYPE_CHROME="chrome";a.BROWSER_TYPE_LIEBAO="liebao";a.BROWSER_TYPE_QZONE="qzone";a.BROWSER_TYPE_SOUGOU="sogou";a.BROWSER_TYPE_UNKNOWN="unknown";a.isNative=!1;var b=window,c=b.navigator,d=document,e=d.documentElement,h=c.userAgent.toLowerCase();a.isMobile=-1!==h.indexOf("mobile")||-1!==h.indexOf("android");a.platform=a.isMobile?a.MOBILE_BROWSER:a.DESKTOP_BROWSER;var m=c.language,m=(m=m?m:c.browserLanguage)?m.split("-")[0]:a.LANGUAGE_ENGLISH;a.language=m;var k=
m=!1,z="",y=0,x=/android (\d+(?:\.\d+)+)/i.exec(h)||/android (\d+(?:\.\d+)+)/i.exec(c.platform);x&&(m=!0,z=x[1]||"",y=parseInt(z)||0);if(x=/(iPad|iPhone|iPod).*OS ((\d+_?){2,3})/i.exec(h))k=!0,z=x[2]||"",y=parseInt(z)||0;x=a.OS_UNKNOWN;-1!==c.appVersion.indexOf("Win")?x=a.OS_WINDOWS:k?x=a.OS_IOS:-1!==c.appVersion.indexOf("Mac")?x=a.OS_OSX:-1!==c.appVersion.indexOf("X11")&&-1===c.appVersion.indexOf("Linux")?x=a.OS_UNIX:m?x=a.OS_ANDROID:-1!==c.appVersion.indexOf("Linux")&&(x=a.OS_LINUX);a.os=x;a.osVersion=
z;a.osMainVersion=y;a.browserType=a.BROWSER_TYPE_UNKNOWN;(function(){var b=/qqbrowser|chrome|safari|firefox|opr|oupeng|opera/i,c=/sogou|qzone|liebao|micromessenger|ucbrowser|360 aphone|360browser|baiduboxapp|baidubrowser|maxthon|mxbrowser|trident|miuibrowser/i.exec(h);c||(c=b.exec(h));b=c?c[0]:a.BROWSER_TYPE_UNKNOWN;"micromessenger"===b?b=a.BROWSER_TYPE_WECHAT:"safari"===b&&h.match(/android.*applewebkit/)?b=a.BROWSER_TYPE_ANDROID:"trident"===b?b=a.BROWSER_TYPE_IE:"360 aphone"===b?b=a.BROWSER_TYPE_360:
"mxbrowser"===b?b=a.BROWSER_TYPE_MAXTHON:"opr"===b&&(b=a.BROWSER_TYPE_OPERA);a.browserType=b})();a.browserVersion="";(function(){var b=/(msie |rv:|firefox|chrome|ucbrowser|qq|oupeng|opera|opr|safari|miui)(mobile)?(browser)?\/?([\d.]+)/i,c=h.match(/(micromessenger|mx|maxthon|baidu|sogou)(mobile)?(browser)?\/?([\d.]+)/i);c||(c=h.match(b));a.browserVersion=c?c[4]:""})();m=window.devicePixelRatio||1;a.windowPixelResolution={width:m*(window.innerWidth||document.documentElement.clientWidth),height:m*(window.innerHeight||
...
cc.sys.isMobile&&(m=document.createElement("style"),m.type="text/css",document.body.appendChild(m),m.textContent="body,canvas,div{ -moz-user-select: none;-webkit-user-select: none;-ms-user-select: none;-khtml-user-select: none;-webkit-tap-highlight-color:rgba(0,0,0,0);}");try{var w=a.localStorage=b.localStorage;w.setItem("storage","");w.removeItem("storage");w=null}catch(B){w=function(){cc.warn("Warning: localStorage isn't enabled. Please confirm browser cookie or privacy option")},a.localStorage=
{getItem:w,setItem:w,removeItem:w,clear:w}}w=!!f.getContext("2d");m=!1;k=document.createElement("CANVAS");if(b.WebGLRenderingContext)try{cc.create3DContext(k,{stencil:!0,preserveDrawingBuffer:!0})&&(m=!0)}catch(C){}w=a.capabilities={canvas:w,opengl:m};if(void 0!==e.ontouchstart||void 0!==d.ontouchstart||c.msPointerEnabled)w.touches=!0;void 0!==e.onmouseup&&(w.mouse=!0);void 0!==e.onkeyup&&(w.keyboard=!0);if(b.DeviceMotionEvent||b.DeviceOrientationEvent)w.accelerometer=!0;a.garbageCollect=function(){};
...
cc.clone(this.__getters__));this.__setters__&&(c.__setters__=cc.clone(this.__setters__));for(var f=0,h=arguments.length;f<h;++f){var k=arguments[f],m;for(m in k){var n="function"===typeof k[m],p="function"===typeof d[m],t=a.test(k[m]);n&&p&&t?(g.value=function(a,b){return function(){var c=this._super;this._super=d[a];var e=b.apply(this,arguments);this._super=c;return e}}(m,k[m]),Object.defineProperty(e,m,g)):n?(g.value=k[m],Object.defineProperty(e,m,g)):e[m]=k[m];if(n){var r,u;if(this.__getters__&&
this.__getters__[m]){var n=this.__getters__[m],s;for(s in this.__setters__)if(this.__setters__[s]===n){u=s;break}cc.defineGetterSetter(e,n,k[m],k[u]?k[u]:e[u],m,u)}if(this.__setters__&&this.__setters__[m]){n=this.__setters__[m];for(s in this.__getters__)if(this.__getters__[s]===n){r=s;break}cc.defineGetterSetter(e,n,k[r]?k[r]:e[r],k[m],r,m)}}}}c.extend=cc.Class.extend;c.implement=function(a){for(var b in a)e[b]=a[b]};return c}})();
...
a[b]};cc.FontDefinition.prototype._getCanvasFontStr=function(){return this.fontStyle+" "+this.fontWeight+" "+this.fontSize+"px/"+(!this.lineHeight.charAt?this.lineHeight+"px":this.lineHeight)+" '"+this.fontName+"'"};cc.game.addEventListener(cc.game.EVENT_RENDERER_INITED,function(){cc._renderType===cc.game.RENDER_TYPE_CANVAS&&(cc.assert(cc.isFunction(cc._tmp.PrototypeColor),cc._LogInfos.MissingFile,"CCTypesPropertyDefine.js"),cc._tmp.PrototypeColor(),delete cc._tmp.PrototypeColor)});cc.Touches=[];cc.TouchesIntergerDict={};cc.DENSITYDPI_DEVICE="device-dpi";cc.DENSITYDPI_HIGH="high-dpi";cc.DENSITYDPI_MEDIUM="medium-dpi";cc.DENSITYDPI_LOW="low-dpi";cc.__BrowserGetter={init:function(){this.html=document.getElementsByTagName("html")[0]},availWidth:function(a){return!a||a===this.html?window.innerWidth:a.clientWidth},availHeight:function(a){return!a||a===this.html?window.innerHeight:a.clientHeight},meta:{width:"device-width"},adaptationType:cc.sys.browserType};
...
0<b&&a.setDesignResolutionSize(b,c,a._resolutionPolicy))},setTargetDensityDPI:function(a){this._targetDensityDPI=a;this._adjustViewportMeta()},getTargetDensityDPI:function(){return this._targetDensityDPI},resizeWithBrowserSize:function(a){a?this.__resizeWithBrowserSize||(this.__resizeWithBrowserSize=!0,window.addEventListener("resize",this._resizeEvent),window.addEventListener("orientationchange",this._resizeEvent)):this.__resizeWithBrowserSize&&(this.__resizeWithBrowserSize=!1,window.removeEventListener("resize",
...
cc.pSubIn=function(a,b){a.x-=b.x;a.y-=b.y};cc.pAddIn=function(a,b){a.x+=b.x;a.y+=b.y};cc.pNormalizeIn=function(a){cc.pMultIn(a,1/Math.sqrt(a.x*a.x+a.y*a.y))};cc.vertexLineToPolygon=function(a,b,c,d,e){e+=d;if(!(1>=e)){b*=0.5;for(var f,g=e-1,h=d;h<e;h++){f=2*h;var k=cc.p(a[2*h],a[2*h+1]),m;if(0===h)m=cc.pPerp(cc.pNormalize(cc.pSub(k,cc.p(a[2*(h+1)],a[2*(h+1)+1]))));else if(h===g)m=cc.pPerp(cc.pNormalize(cc.pSub(cc.p(a[2*(h-1)],a[2*(h-1)+1]),k)));else{m=cc.p(a[2*(h-1)],a[2*(h-1)+1]);var n=cc.p(a[2*(h+1)],a[2*(h+1)+1]),p=cc.pNormalize(cc.pSub(n,k)),t=cc.pNormalize(cc.pSub(m,k)),r=Math.acos(cc.pDot(p,t));m=r<cc.degreesToRadians(70)?cc.pPerp(cc.pNormalize(cc.pMidpoint(p,
t))):r<cc.degreesToRadians(170)?cc.pNormalize(cc.pMidpoint(p,t)):cc.pPerp(cc.pNormalize(cc.pSub(n,m)))}m=cc.pMult(m,b);c[2*f]=k.x+m.x;c[2*f+1]=k.y+m.y;c[2*(f+1)]=k.x-m.x;c[2*(f+1)+1]=k.y-m.y}for(h=0===d?0:d-1;h<g;h++){f=2*h;a=f+2;b=cc.vertex2(c[2*f],c[2*f+1]);e=cc.vertex2(c[2*(f+1)],c[2*(f+1)+1]);f=cc.vertex2(c[2*a],c[2*a]);d=cc.vertex2(c[2*(a+1)],c[2*(a+1)+1]);b=!cc.vertexLineIntersect(b.x,b.y,d.x,d.y,e.x,e.y,f.x,f.y);if(!b.isSuccess&&(0>b.value||1<b.value))b.isSuccess=!0;b.isSuccess&&(c[2*a]=d.x,
...
f.ty+f.b*d.tx}else e.a=d.a,e.b=d.b,e.c=d.c,e.d=d.d,e.tx=d.tx,e.ty=d.ty;if(c&&(d=this._node._children)&&0!==d.length){e=0;for(f=d.length;e<f;e++)d[e]._renderCmd.transform(this,c)}};a.visit=function(a){if(this._node._visible){if(a=a||this.getParentRenderCmd())this._curLevel=a._curLevel+1;this._syncStatus(a);this.visitChildren()}};a.setDirtyFlag=function(a,c){cc.Node.RenderCmd.prototype.setDirtyFlag.call(this,a,c);this._setCacheDirty(c);this._cachedParent&&this._cachedParent.setDirtyFlag(a,!0)};a._setCacheDirty=
...
e=d.a,f=d.b,g=d.c,h=d.d;cc.Node.CanvasRenderCmd.prototype.transform.call(this,a,c);if((d.a!==e||d.b!==f||d.c!==g||d.d!==h)&&0===this._updateCache)this._updateCache=2};a.bake=function(){if(!this._isBaked){this._needDraw=!0;this._isBaked=this._cacheDirty=cc.renderer.childrenOrderDirty=!0;0===this._updateCache&&(this._updateCache=2);for(var a=this._node._children,c=0,d=a.length;c<d;c++)a[c]._renderCmd._setCachedParent(this);this._bakeSprite||(this._bakeSprite=new cc.BakeSprite,this._bakeSprite.setAnchorPoint(0,
...
this._node,f=this._textureCoord,g=this._displayedOpacity/255,h=this._textureToRender||e._texture;if(!(h&&(0===f.width||0===f.height||!h._textureLoaded)||0===g)){a=a||cc._renderContext;var k=a.getContext(),m=e._offsetPosition.x,n=e._rect.height,p=e._rect.width,t=-e._offsetPosition.y-n;a.setTransform(this._worldTransform,c,d);a.setCompositeOperation(this._blendFuncStr);a.setGlobalAlpha(g);(e._flippedX||e._flippedY)&&a.save();e._flippedX&&(m=-m-p,k.scale(-1,1));e._flippedY&&(t=e._offsetPosition.y,k.scale(1,
-1));var r,u,s;this._colorized?r=g=0:(g=f.renderX,r=f.renderY);u=f.width;s=f.height;m*=c;t*=d;p*=c;n*=d;h?(c=h._htmlElementObj,""!==h._pattern?(a.setFillStyle(k.createPattern(c,h._pattern)),k.fillRect(m,t,p,n)):k.drawImage(c,g,r,u,s,m,t,p,n)):(h=e._contentSize,f.validRect&&(f=this._displayedColor,a.setFillStyle("rgba("+f.r+","+f.g+","+f.b+",1)"),k.fillRect(m,t,h.width*c,h.height*d)));(e._flippedX||e._flippedY)&&a.restore();cc.g_NumberOfDraws++}};a._updateColor=function(){var a=this._node._texture,
...
a.updateTransform=function(){var a=this._node;if(a.dirty){var c=a._parent;!a._visible||c&&c!==a._batchNode&&c._shouldBeHidden?a._shouldBeHidden=!0:(a._shouldBeHidden=!1,a._transformToBatch=!c||c===a._batchNode?this.getNodeToParentTransform():cc.affineTransformConcat(this.getNodeToParentTransform(),c._transformToBatch));a._recursiveDirty=!1;a.dirty=!1}a._hasChildren&&a._arrayMakeObjectsPerformSelector(a._children,cc.Node._stateCallbackType.updateTransform)};a._spriteFrameLoadedCallback=function(a){this.setTextureRect(a.getRect(),
...
c.dst===cc.BLEND_DST&&(c.src=cc.SRC_ALPHA),a.opacityModifyRGB=!1):(c.src===cc.SRC_ALPHA&&c.dst===cc.BLEND_DST&&(c.src=cc.ONE),a.opacityModifyRGB=!0)}};a._setTexture=function(a){var c=this._node;if(c._batchNode){if(c._batchNode.texture!==a){cc.log(cc._LogInfos.Sprite_setTexture);return}}else c._texture!==a&&(c._textureLoaded=a?a._textureLoaded:!1,c._texture=a,this._updateBlendFunc());this._shaderProgram=a?cc.shaderCache.programForKey(cc.SHADER_POSITION_TEXTURECOLOR):cc.shaderCache.programForKey(cc.SHADER_POSITION_COLOR)};
...
this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty))},_updateString:function(){if((!this._string||""===this._string)&&this._string!==this._originalText)cc.renderer.childrenOrderDirty=!0;this._string=this._originalText},setHorizontalAlignment:function(a){a!==this._hAlignment&&(this._hAlignment=a,this._setUpdateTextureDirty())},setVerticalAlignment:function(a){a!==this._vAlignment&&(this._vAlignment=a,this._setUpdateTextureDirty())},setDimensions:function(a,b){var c;void 0===b?(c=a.width,
...
d,c)}else{this._strings=a._string.split("\n");d=0;for(e=this._strings.length;d<e;d++)f.push(this._measure(this._strings[d]))}1<this._strings.length&&(this._isMultiLine=!0);e=d=0;a._strokeEnabled&&(d=e=2*a._strokeSize);if(a._shadowEnabled){var g=a._shadowOffset;d+=2*Math.abs(g.x);e+=2*Math.abs(g.y)}c=0===c?this._isMultiLine?cc.size(Math.ceil(Math.max.apply(Math,f)+d),Math.ceil(this._fontClientHeight*this._strings.length+e)):cc.size(Math.ceil(this._measure(a._string)+d),Math.ceil(this._fontClientHeight+
...
1));if(c.currentActionSalvaged)c.currentAction=null;else if(c.currentAction.isDone()){c.currentAction.stop();var e=c.currentAction;c.currentAction=null;this.removeAction(e)}c.currentAction=null}this._currentTargetSalvaged&&0===c.actions.length&&this._deleteHashElement(c)&&d--}}});cc.profiler=function(){var a=_showFPS=!1,b=_frameRate=_lastSPF=_accumDt=0;_afterVisitListener=_FPSLabel=_SPFLabel=_drawsLabel=null;var c=10,d=[0,10,20,30],e=[0,0,0,0],f=3,g=0,h=0,k=function(){_lastSPF=cc.director.getSecondsPerFrame();b++;_accumDt+=cc.director.getDeltaTime();if(_accumDt>cc.DIRECTOR_FPS_INTERVAL){_frameRate=b/_accumDt;_accumDt=b=0;if(n.onFrameRateChange){var a=_frameRate,m=i=d.length-1,k=0;g++;for(h+=a;0<=i;i--)if(a>=d[i]){e[i]++;break}if(g>=c){k=h/c;for(i=m;0<i;i--)if(a=e[i]/c,0.6<=
a&&k>=d[i]){i!=f&&(f=i,n.onFrameRateChange&&n.onFrameRateChange(k.toFixed(2)));break}h=g=_changeCount=0;for(i=m;0<i;i--)e[i]=0}}_showFPS&&(_SPFLabel.string=_lastSPF.toFixed(3),_FPSLabel.string=_frameRate.toFixed(1),_drawsLabel.string=(0|cc.g_NumberOfDraws).toString())}_showFPS&&(_FPSLabel.visit(),_SPFLabel.visit(),_drawsLabel.visit())},m=function(){_FPSLabel._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty);_SPFLabel._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty);_drawsLabel._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty)},
...
d=cc.DIRECTOR_STATS_POSITION,b=b>c?0|24*(c/320):0|24*(b/320);_FPSLabel=new cc.LabelTTF("000.0","Arial",b);_SPFLabel=new cc.LabelTTF("0.000","Arial",b);_drawsLabel=new cc.LabelTTF("0000","Arial",b);_drawsLabel.setPosition(_drawsLabel.width/2+d.x,5*_drawsLabel.height/2+d.y);_SPFLabel.setPosition(_SPFLabel.width/2+d.x,3*_SPFLabel.height/2+d.y);_FPSLabel.setPosition(_FPSLabel.width/2+d.x,_FPSLabel.height/2+d.y)}_FPSLabel&&(_showFPS=!0)},hideStats:function(){_showFPS=!1},init:function(){a||(_afterVisitListener=
...
h))return null;b.assignFrom(g);return b};b.inverse=function(){var b=new a.math.Matrix4(this),d=new a.math.Matrix4(c);return!1===a.math.Matrix4._gaussj(b,d)?null:b};b.isIdentity=function(){var a=this.mat;return 1===a[0]&&0===a[1]&&0===a[2]&&0===a[3]&&0===a[4]&&1===a[5]&&0===a[6]&&0===a[7]&&0===a[8]&&0===a[9]&&1===a[10]&&0===a[11]&&0===a[12]&&0===a[13]&&0===a[14]&&1===a[15]};b.transpose=function(){var a=this.mat,b=a[1],c=a[2],d=a[3],k=a[6],m=a[7],n=a[8],p=a[9],t=a[11],r=a[12],u=a[13],s=a[14];a[1]=a[4];
a[2]=n;a[3]=r;a[4]=b;a[6]=p;a[7]=u;a[8]=c;a[9]=k;a[11]=s;a[12]=d;a[13]=m;a[14]=t;return this};a.kmMat4Multiply=function(a,b,c){var d=a.mat,k=b.mat,m=c.mat;c=k[0];b=k[1];var n=k[2],p=k[3],t=k[4],r=k[5],u=k[6],s=k[7],v=k[8],A=k[9],z=k[10],y=k[11],x=k[12],w=k[13],B=k[14],k=k[15],C=m[0],D=m[1],E=m[2],F=m[3],G=m[4],H=m[5],I=m[6],J=m[7],K=m[8],L=m[9],M=m[10],N=m[11],O=m[12],P=m[13],Q=m[14],m=m[15];d[0]=C*c+D*t+E*v+F*x;d[1]=C*b+D*r+E*A+F*w;d[2]=C*n+D*u+E*z+F*B;d[3]=C*p+D*s+E*y+F*k;d[4]=G*c+H*t+I*v+J*x;d[5]=
G*b+H*r+I*A+J*w;d[6]=G*n+H*u+I*z+J*B;d[7]=G*p+H*s+I*y+J*k;d[8]=K*c+L*t+M*v+N*x;d[9]=K*b+L*r+M*A+N*w;d[10]=K*n+L*u+M*z+N*B;d[11]=K*p+L*s+M*y+N*k;d[12]=O*c+P*t+Q*v+m*x;d[13]=O*b+P*r+Q*A+m*w;d[14]=O*n+P*u+Q*z+m*B;d[15]=O*p+P*s+Q*y+m*k;return a};b.multiply=function(a){var b=this.mat,c=a.mat;a=b[0];var d=b[1],k=b[2],m=b[3],n=b[4],p=b[5],t=b[6],r=b[7],u=b[8],s=b[9],v=b[10],A=b[11],z=b[12],y=b[13],x=b[14],w=b[15],B=c[0],C=c[1],D=c[2],E=c[3],F=c[4],G=c[5],H=c[6],I=c[7],J=c[8],K=c[9],L=c[10],M=c[11],N=c[12],
O=c[13],P=c[14],c=c[15];b[0]=B*a+C*n+D*u+E*z;b[1]=B*d+C*p+D*s+E*y;b[2]=B*k+C*t+D*v+E*x;b[3]=B*m+C*r+D*A+E*w;b[4]=F*a+G*n+H*u+I*z;b[5]=F*d+G*p+H*s+I*y;b[6]=F*k+G*t+H*v+I*x;b[7]=F*m+G*r+H*A+I*w;b[8]=J*a+K*n+L*u+M*z;b[9]=J*d+K*p+L*s+M*y;b[10]=J*k+K*t+L*v+M*x;b[11]=J*m+K*r+L*A+M*w;b[12]=N*a+O*n+P*u+c*z;b[13]=N*d+O*p+P*s+c*y;b[14]=N*k+O*t+P*v+c*x;b[15]=N*m+O*r+P*A+c*w;return this};a.getMat4MultiplyValue=function(a,b){var c=a.mat,d=b.mat,k=new Float32Array(16);k[0]=c[0]*d[0]+c[4]*d[1]+c[8]*d[2]+c[12]*d[3];
...
for(var m=e.quads,n=this._displayedColor,n={r:n.r,g:n.g,b:n.b,a:a._displayedOpacity},p=a._itemWidth,t=a._itemHeight,r=0,u=-1;r<d;r++){var s=c.charCodeAt(r)-a._mapStartChar.charCodeAt(0),v=s%a._itemsPerRow,A=0|s/a._itemsPerRow;if(!(0>v||0>A))if(!(v*p+p>g||A*t+t>f)){u++;var z;cc.FIX_ARTIFACTS_BY_STRECHING_TEXEL?(v=(2*v*h+1)/(2*g),s=v+(2*h-2)/(2*g),A=(2*A*k+1)/(2*f),z=A+(2*k-2)/(2*f)):(v=v*h/g,s=v+h/g,A=A*k/f,z=A+k/f);var y=m[r],x=y.tl,w=y.tr,B=y.bl,y=y.br;x.texCoords.u=v;x.texCoords.v=A;w.texCoords.u=
s;w.texCoords.v=A;B.texCoords.u=v;B.texCoords.v=z;y.texCoords.u=s;y.texCoords.v=z;B.vertices.x=u*p;B.vertices.y=0;B.vertices.z=0;y.vertices.x=u*p+p;y.vertices.y=0;y.vertices.z=0;x.vertices.x=u*p;x.vertices.y=a._itemHeight;x.vertices.z=0;w.vertices.x=u*p+p;w.vertices.y=a._itemHeight;w.vertices.z=0;x.colors=n;w.colors=n;B.colors=n;y.colors=n}}this.updateContentSize(r,u+1);0<d&&(e.dirty=!0,a=e.totalQuads,d>a&&e.increaseTotalQuadsWith(d-a))};a.updateContentSize=function(a,c){var d=this._node,e=d._contentSize;
...
null==c?-1:c,this._realOpacity=255,this._realColor=cc.color(255,255,255,255),this._contentSize.width=0,this._contentSize.height=0,this.setAnchorPoint(0.5,0.5),this._renderCmd._initBatchTexture(),this.setString(a,!0),!0):!1},createFontChars:function(){var a=this._renderCmd._texture||this.textureAtlas.texture,b=0,c=cc.size(0,0),d=0,e=1,f=this._string,g=f?f.length:0;if(0!==g){var h,k=this._config,m=k.kerningDict,n=k.commonHeight,p=k.fontDefDictionary;for(h=0;h<g-1;h++)10===f.charCodeAt(h)&&e++;var t=
n*e,e=-(n-n*e),r=-1;for(h=0;h<g;h++)if(n=f.charCodeAt(h),0!==n)if(10===n)b=0,e-=k.commonHeight;else{var r=m[r<<16|n&65535]||0,u=p[n];u||(cc.log("cocos2d: LabelBMFont: character not found "+f[h]),u={rect:{x:0,y:0,width:0,height:0},xOffset:0,yOffset:0,xAdvance:0});var s=cc.rect(u.rect.x,u.rect.y,u.rect.width,u.rect.height),s=cc.rectPixelsToPoints(s);s.x+=this._imageOffset.x;s.y+=this._imageOffset.y;var v=this.getChildByTag(h);v?this._renderCmd._updateCharTexture(v,s,n):(v=new cc.Sprite,v.initWithTexture(a,
s,!1),v._newTextureWhenChangeColor=!0,this.addChild(v,0,h));v.opacityModifyRGB=this._opacityModifyRGB;this._renderCmd._updateCharColorAndOpacity(v);s=cc.p(b+u.xOffset+0.5*u.rect.width+r,e+(k.commonHeight-u.yOffset)-0.5*s.height*cc.contentScaleFactor());v.setPosition(cc.pointPixelsToPoints(s));b+=u.xAdvance+r;r=n;d<b&&(d=b)}c.width=u&&u.xAdvance<u.rect.width?d-u.xAdvance+u.rect.width:d;c.height=t;this.setContentSize(cc.sizePixelsToPoints(c))}},updateString:function(a){var b=this._children;if(b)for(var c=
...
c.y),cc.p(c.x+a.width,c.y),cc.p(c.x+a.width,c.y+a.height),cc.p(c.x,c.y+a.height)];cc._drawingUtil.setDrawColor(0,255,0,255);cc._drawingUtil.drawPoly(a,4,!0)}};a._updateCharColorAndOpacity=function(){}})();cc.ACTION_TAG_INVALID=-1;
...
!0);break;case a.BROWSER_TYPE_MIUI:if(cc.sys.isMobile&&(b=b.match(/\d+/g),2>b[0]||2===b[0]&&0===b[1]&&1>=b[2]))window.__audioSupport.AUTOPLAY=!1}})();
...
window.mozAudioContext);a.DELAY_CREATE_CTX&&setTimeout(function(){f=new (window.AudioContext||window.webkitAudioContext||window.mozAudioContext)},0)}}catch(g){b=!1,cc.log("browser don't support web audio")}var h={cache:{},load:function(c,d,g,k){if(0===e.length)return k("can not support audio!");cc.loader.audioPath&&(c=cc.path.join(cc.loader.audioPath,c));var r=cc.path.extname(c),u=[r];for(g=0;g<e.length;g++)r!==e[g]&&u.push(e[g]);var s;if(h.cache[d])return k(null,h.cache[d]);if(b)try{var v=f.createGain();
v.gain.value=1;v.connect(f.destination);s=new cc.Audio(f,v,c);a.NEED_MANUAL_LOOP&&(s._manualLoop=!0)}catch(A){b=!1,cc.log("browser don't support web audio"),s=new cc.Audio(null,null,c)}else s=new cc.Audio(null,null,c);this.loadAudioFromExtList(c,u,s,k);h.cache[d]=s},loadAudioFromExtList:function(c,d,g,k){if(0===d.length){var r="can not found the resource of audio! Last match url is : ",r=r+c.replace(/\.(.*)?$/,"(");e.forEach(function(a){r+=a+"|"});r=r.replace(/\|$/,")");return k({status:520,errorMessage:r},
null)}c=cc.path.changeExtname(c,d.splice(0,1));if(b){a.webAudioCallback&&a.webAudioCallback(c);var u=new XMLHttpRequest;u.open("GET",c,!0);u.responseType="arraybuffer";u.onload=function(){f.decodeAudioData(u.response,function(a){g.setBuffer(a);k(null,g)},function(){h.loadAudioFromExtList(c,d,g,k)})};u.onerror=function(){k({status:520,errorMessage:r},null)};u.send()}else{var s=document.createElement("audio"),v=!1,A=!1,z=setTimeout(function(){0===s.readyState?w():(A=!0,s.pause(),document.body.removeChild(s),
k("audio load timeout : "+c,g))},1E4),y=function(){if(!v){try{s.currentTime=0,s.volume=1}catch(a){}document.body.removeChild(s);g.setElement(s);s.removeEventListener("canplaythrough",y,!1);s.removeEventListener("error",x,!1);s.removeEventListener("emptied",w,!1);!A&&k(null,g);v=!0;clearTimeout(z)}},x=function(){v&&(document.body.removeChild(s),s.removeEventListener("canplaythrough",y,!1),s.removeEventListener("error",x,!1),s.removeEventListener("emptied",w,!1),!A&&h.loadAudioFromExtList(c,d,g,k),
v=!0,clearTimeout(z))},w=function(){A=!0;y();k(null,g)};s.addEventListener("canplaythrough",y,!1);s.addEventListener("error",x,!1);a.USE_EMPTIED_EVENT&&s.addEventListener("emptied",w,!1);s.src=c;document.body.appendChild(s);s.volume=0}}};cc.loader.register(["mp3","ogg","wav","mp4","m4a"],h);cc.audioEngine={_currMusic:null,_musicVolume:1,features:a,willPlayMusic:function(){return!1},playMusic:function(a,b){var c=this._currMusic;c&&(c.src!==a&&c.getPlaying())&&c.stop();c=h.cache[a];c||(cc.loader.load(a),
...
cc._canvas.removeEventListener("touchstart",k))};setTimeout(function(){cc._canvas&&cc._canvas.addEventListener("touchstart",k,!1)},150)}})(window.__audioSupport);var res={ui_plist:"res/ui.plist",ui_png:"res/ui.png",NianShouA_png:"res/NianShou"+DynamicData.nianshouType+".png",NianShouA_plist:"res/NianShou"+DynamicData.nianshouType+".plist",YongZhe_png:"res/YongZhe.png",YongZhe_plist:"res/YongZhe.plist",Effect_png:"res/Effect.png",Effect_plist:"res/Effect.plist",Bishaji_png:"res/Bishaji.png",Bishaji_plist:"res/Bishaji.plist",Hurt_png:"res/Hurt.png",Hurt_fnt:"res/Hurt.fnt",BeigongjiA_sfx:"res/beigongji"+DynamicData.nianshouType+".wav",GongjiA_sfx:"res/gongji"+
DynamicData.nianshouType+".wav",YzBeigongji_sfx:"res/yzBeigongji.wav",YzGongji_sfx:"res/yzGongji.wav",YzDaoguang_sfx:"res/yzDaoguang.wav",YzMofa_sfx:"res/yzMofa.wav"},g_resources=[],i;for(i in res)g_resources.push(res[i]);var CustomLoaderScene=cc.Scene.extend({_interval:null,_label:null,_className:"CustomLoaderScene",cb:null,target:null,loadingBar:null,ctor:function(){this._super();this.init();return!0},init:function(){var a=this._bgLayer=new cc.LayerColor(cc.color(32,32,32,255));this.addChild(a,0);var b=cc.visibleRect,c=new cc.Sprite("res/loading.png");c.setPosition(b.center.x,b.center.y);this.loadingBar=new cc.Sprite("res/loadingBar.png");this.loadingBar.setPosition(b.center.x,b.center.y-4);this.loadingBar.setScale(1E-8,
1);this.addChild(c);this.addChild(this.loadingBar);b=this._label=new cc.LabelTTF("\u52c7\u8005\u5bfb\u8def\u4e2d... 0%","Arial",24);b.setPosition(cc.pAdd(cc.visibleRect.center,cc.p(0,73)));b.setColor(cc.color(180,180,180));a.addChild(this._label,10);return!0},_initStage:function(a,b){var c=this._texture2d=new cc.Texture2D;c.initWithElement(a);c.handleLoadedTexture();c=this._logo=new cc.Sprite(c);c.setScale(cc.contentScaleFactor());c.x=b.x;c.y=b.y;this._bgLayer.addChild(c,10)},onEnter:function(){cc.Node.prototype.onEnter.call(this);
this.schedule(this._startLoading,0.3)},onExit:function(){cc.Node.prototype.onExit.call(this);this._label.setString("\u52c7\u8005\u5bfb\u8def\u4e2d... 0%")},initWithResources:function(a,b,c){cc.isString(a)&&(a=[a]);this.resources=a||[];this.cb=b;this.target=c},_startLoading:function(){var a=this;a.unschedule(a._startLoading);cc.loader.load(a.resources,function(b,c,d){b=Math.min(100*(d/c)|0,100);a._label.setString("\u52c7\u8005\u5bfb\u8def\u4e2d ... "+b+"%");a.loadingBar.setScale(b/100,1)},function(){a.cb&&
a.cb.call(a.target)})},_updateTransform:function(){this._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty);this._bgLayer._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty);this._label._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty);this._logo._renderCmd.setDirtyFlag(cc.Node._dirtyFlags.transformDirty)}});function getAnimation(a,b,c,d,e){void 0==c&&(c=1);void 0==d&&(d=8);void 0==e&&(e=1);for(var f=new cc.Animation;c<=b;c++){var g=c.toString();10>c&&(g="0"+c);(g=cc.spriteFrameCache.getSpriteFrame(a+g+".png"))&&f.addSpriteFrame(g)}f.setDelayPerUnit(1/d);f.setLoops(e);return f}function ShareToWebsites(a,b,c,d){switch(a){case "qq":ShareToQQZone(b,c);break;case "weibo":ShareToWeibo(c);break;case "weixin":ShareToWeiXin(c);break;default:callWebShare()}window.onfocus=function(){d();window.onfocus=null}}
function ShareToWeibo(a){window.open("http://service.weibo.com/share/share.php?url\x3d"+DynamicData.shareURL+"\x26title\x3d"+a+"\x26searchPic\x3dtrue\x26pic\x3d"+DynamicData.sharePic)}function ShareToQQZone(a,b){window.open("http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url\x3d"+DynamicData.shareURL+"\x26title\x3d"+a+"\x26pics\x3d"+DynamicData.sharePic+"\x26summary\x3d"+b)}
function ShareToWeiXin(a){console.log("call ShareToWeiXin: "+a);isExitsVariable(window.parent.wxInfo)&&(window.parent.wxInfo.desc=a,window.parent.UpdateWeiXin())}function isExitsVariable(a){return"undefined"==typeof a?!1:!0};var Game={gameInstance:null,nianHP:100,nianHPMax:100,playerHP:100,playerHPMax:100,scaleAniBy:2.5};var Creature=cc.Sprite.extend({_chuchangPrefix:"",_gongjiPrefix:"",_beijiPrefix:"",_daijiPrefix:"",_fashuPrefix:"",kActionTagAni:1,ctor:function(a,b,c,d,e){this._chuchangPrefix=a;this._gongjiPrefix=b;this._beijiPrefix=c;this._daijiPrefix=d;this._fashuPrefix=e;this._super("#"+a+"/01.png");return!0},gongji:function(a,b){this.stopAllActions();var c=new cc.animate(getAnimation(this._gongjiPrefix+"/",9,1,10));c.setTag(this.kActionTagAni);this.runAction(new cc.Sequence(c,new cc.CallFunc(this.daiji,this),
new cc.CallFunc(a,b)))},fashu:function(a,b){this.stopAllActions();var c=new cc.animate(getAnimation(this._fashuPrefix+"/",9,1,10));c.setTag(this.kActionTagAni);this.runAction(new cc.Sequence(c,new cc.CallFunc(this.daiji,this),new cc.CallFunc(a,b)))},beigongji:function(){this.stopAllActions();var a=new cc.animate(getAnimation(this._beijiPrefix+"/",9)),b=new cc.Repeat(new cc.Sequence(new cc.MoveBy(0.03,10,20),new cc.MoveBy(0.03,-20,-10),new cc.MoveBy(0.03,-10,10),new cc.MoveBy(0.03,20,-20)),3);this.runAction(b);
a=new cc.Sequence(a,new cc.CallFunc(this.daiji,this));a.setTag(this.kActionTagAni);this.runAction(a)},daiji:function(){this.stopAllActions();var a=new cc.RepeatForever(new cc.animate(getAnimation(this._daijiPrefix+"/",10)));a.setTag(this.kActionTagAni);this.runAction(a)},chuchang:function(){this.stopAllActions();var a=new cc.animate(getAnimation(this._chuchangPrefix+"/",9)),a=new cc.Sequence(a,new cc.CallFunc(this.daiji,this));a.setTag(this.kActionTagAni);this.runAction(a)},actionOverCb:null});var ShareUI=cc.Layer.extend({_bg:null,_menu:null,_btnShare:null,ctor:function(){this._super();var a=cc.winSize,b=a.width/2,a=a.height/2;this._bg=new cc.Sprite("#shareBg.png");this.addChild(this._bg);this._bg.setPosition(b,a+100);return!0},init:function(){this._btnShare=new cc.MenuItemImage("#shareBtn.png","#shareBtn2.png","#shareBtn2.png",this.share,this);this._menu=new cc.Menu(this._btnShare);this._menu.setPosition(this._bg.x,this._bg.y-0.26*this._bg.height);this.addChild(this._menu)},share:function(){if(isApp)callAppFunction("popupSharePanel",
{title:DynamicData.shareTitle,describe:DynamicData.shareContent,imageurl:DynamicData.sharePic,page_url:DynamicData.shareURL,weibo_describe:DynamicData.shareContentWeibo}),this._btnShare.setEnabled(!1),this.scheduleOnce(this.manualShare,10);else if(isWeixin||isQQ||isWeibo){var a=cc.visibleRect,b=new cc.LayerColor(cc.color(22,22,22,160));this.addChild(b);b=new cc.Sprite("res/shareTip.png");b.setAnchorPoint(1,1);b.setPosition(a.topRight);this.addChild(b);this._btnShare.setEnabled(!1);this.scheduleOnce(this.manualShare,
10)}else this._menu.removeChild(this._btnShare),ShareToWebsites("",DynamicData.shareTitle,DynamicData.shareContent,Game.gameInstance.onShared.bind(Game.gameInstance))},shareQQ:function(){ShareToWebsites("qq",DynamicData.shareTitle,DynamicData.shareContent,Game.gameInstance.onShared.bind(Game.gameInstance))},shareWeibo:function(){ShareToWebsites("weibo",DynamicData.shareTitle,DynamicData.shareContentWeibo,Game.gameInstance.onShared.bind(Game.gameInstance))},manualShare:function(){var a=cc.visibleRect,
b=new cc.MenuItemImage("#jiejuBtn1.png","#jiejuBtn2.png",this.manualShareClick,this);b.setAnchorPoint(0,1);b=new cc.Menu(b);b.setPosition(a.width-351,a.height-201);this.addChild(b)},manualShareClick:function(){Game.gameInstance.onShared()}});var GameScene=cc.Scene.extend({_bg:null,_clayer:null,_nianshou:null,_yongzhe:null,_frame:0,_lastDanmuY:0,_roundUI:null,_hp:null,_hpBar:null,_zhandouBtn:null,_mofaBtn:null,_yzMenu:null,_yzHp:null,_yzHpBar:null,_yzSp:null,_yzSpBar:null,_curRound:0,_tfBt:null,_tf:null,_uiLayer:null,_bishaji:null,_lastPickWords:"",kTagDanmu:9,kTagShareUI:10,ctor:function(){this._super();var a=cc.winSize,b=a.width/2,a=a.height/2;this._clayer=new cc.Layer;this.addChild(this._clayer);this._bg=new cc.Sprite("#bg.png");this._clayer.addChild(this._bg);
this._bg.setPosition(b,a);this._nianshou=new Creature("chuchang","gongji","beigongji","daiji");this._clayer.addChild(this._nianshou);this._nianshou.setPosition(b,a);this._nianshou.setScale(Game.scaleAniBy);this._nianshou.chuchang();this.initYongzhe();this._uiLayer=new cc.Layer;this.addChild(this._uiLayer);this._tfBg=new cc.Sprite("#tfBg.png");this._tfBg.setAnchorPoint(0.5,0);this._tfBg.setPosition(b,0);this._uiLayer.addChild(this._tfBg);this._tf=new cc.LabelTTF("\u91ce\u751f\u7684\u5e74\u517d\uff08\u4eec\uff09\u51fa\u73b0\u4e86\uff01",
"Arial",21);this._tf.setDimensions(0.92*this._tfBg.width,0.85*this._tfBg.height);this._tf.setFontFillColor(cc.color(61,50,40,255));this._tf.setAnchorPoint(0.5,1);this._tf.setPosition(b,0.92*this._tfBg.height);this._uiLayer.addChild(this._tf);this.scheduleUpdate();this.scheduleOnce(this.initUI,7);Game.gameInstance=this;return!0},initYongzhe:function(){var a=cc.winSize,b=a.width/2,a=a.height/2;this._yongzhe=new Creature("yzChuchang","yzGongji","yzBeigongji","yzDaiji","yzFashu");this._clayer.addChild(this._yongzhe);
this._yongzhe.setPosition(b,a);this._yongzhe.chuchang();this._yongzhe.setScale(Game.scaleAniBy)},update:function(){this._frame++;0==this._frame%20&&(DynamicData.danmu.length?this.playDanMu(DynamicData.danmu.shift()):this.unscheduleUpdate())},playDanMu:function(a){a=new cc.LabelTTF(a,"Arial",36);var b=cc.winSize;this._lastDanmuY=0==this._lastDanmuY?0.85*b.height:this._lastDanmuY-55;a.setPosition(b.width+a.width/2,this._lastDanmuY);this.addChild(a,9,this.kTagDanmu);b=new cc.moveBy(6,-(a.width+cc.winSize.width),
0);a.runAction(b)},initUI:function(){var a=cc.winSize.width/2;this._curRound=1;this._roundUI=new cc.Sprite("#ROUND1.png");this._roundUI.setPosition(a,910);this._uiLayer.addChild(this._roundUI);this._hp=new cc.Sprite("#hp.png");this._hp.setAnchorPoint(0,0.5);this._hp.setPosition(345,917);this._uiLayer.addChild(this._hp);this._hpBar=new cc.Sprite("#hpBar.png");this._hpBar.setAnchorPoint(0,0.5);this._hpBar.setPosition(389,919);this._uiLayer.addChild(this._hpBar);this._yzHp=new cc.Sprite("#hp.png");this._yzHp.setAnchorPoint(0,
0.5);this._yzHp.setPosition(10,279);this._uiLayer.addChild(this._yzHp);this._yzHpBar=new cc.Sprite("#hpBar.png");this._yzHpBar.setAnchorPoint(0,0.5);this._yzHpBar.setPosition(54,281);this._uiLayer.addChild(this._yzHpBar);this._yzSp=new cc.Sprite("#sp.png");this._yzSp.setAnchorPoint(0,0.5);this._yzSp.setPosition(10,249);this._uiLayer.addChild(this._yzSp);this._yzSpBar=new cc.Sprite("#spBar.png");this._yzSpBar.setAnchorPoint(0,0.5);this._yzSpBar.setPosition(54,251);this._uiLayer.addChild(this._yzSpBar);
this._zhandouBtn=new cc.MenuItemImage("#gongjiBtn1.png","#gongjiBtn2.png",this.zhandouBtnClick,this);this._zhandouBtn.setPosition(435,376);this._mofaBtn=new cc.MenuItemImage("#mofaBtn1.png","#mofaBtn2.png",this.mofaBtnClick,this);this._mofaBtn.setPosition(435,301);this._yzMenu=new cc.Menu(this._zhandouBtn,this._mofaBtn);this._yzMenu.setPosition(0,0);this._uiLayer.addChild(this._yzMenu);this.logToTf("\u8fdb\u5165\u6218\u6597\u72b6\u6001\u3002\n\u91ce\u751f\u7684\u5e74\u517d\uff08\u4eec\uff09\u51fa\u73b0\u4e86\uff01")},
zhandouBtnClick:function(){this._yzMenu.setVisible(!1);this._yongzhe.gongji(this.nianshouHurt,this);this.scheduleOnce(this.catTurn,2);this.castEffect("daohen",this._yongzhe.x,this._yongzhe.y+150,1);this._lastPickWords=DynamicData.zhandouHurt[this._curRound-1];cc.audioEngine.playEffect(res.YzGongji_sfx);cc.audioEngine.playEffect(res.YzDaoguang_sfx)},mofaBtnClick:function(){this._yzMenu.setVisible(!1);this._yongzhe.fashu(this.nianshouHurt,this);this.scheduleOnce(this.catTurn,2);this.castEffect("mofazhen",
this._yongzhe.x,this._yongzhe.y,1);this._lastPickWords=DynamicData.fashuHurt[this._curRound-1];cc.audioEngine.playEffect(res.YzGongji_sfx);cc.audioEngine.playEffect(res.YzMofa_sfx)},castEffect:function(a,b,c,d){var e=new cc.Sprite("#"+a+"/00.png");e.setScale(Game.scaleAniBy);e.setPosition(b,c);this._clayer.addChild(e);a=new cc.Animate(getAnimation(a+"/",4,0,8,d));e.runAction(new cc.Sequence(a,new cc.CallFunc(e.removeFromParent,e)))},nianshouHurt:function(){var a=Math.ceil(10*Math.random())+1;Game.nianHP-=
a;this.piaoXue(a,this._nianshou.x,this._nianshou.y);this._hpBar.runAction(new cc.ScaleTo(1,Game.nianHP/Game.nianHPMax,1));this._nianshou.beigongji();this.logToTf(this._lastPickWords,a);cc.audioEngine.playEffect(res.BeigongjiA_sfx)},yzHurt:function(){var a=Math.ceil(10*Math.random())+15;Game.playerHP-=a;this.piaoXue(a,this._yongzhe.x,this._yongzhe.y);this._yongzhe.beigongji();this._yzHpBar.runAction(new cc.ScaleTo(1,Game.playerHP/Game.playerHPMax,1));this.logToTf(this._lastPickWords,a);cc.audioEngine.playEffect(res.YzBeigongji_sfx)},
catTurn:function(){this.scheduleOnce(this.nextRound,2);this._nianshou.gongji(this.yzHurt,this);this.castEffect("zhuahen",this._yongzhe.x,this._yongzhe.y);this._lastPickWords=DynamicData.yongshiHurt[this._curRound-1];cc.audioEngine.playEffect(res.GongjiA_sfx)},nextRound:function(){this._curRound++;3<this._curRound?(console.log("NextRound ",this._curRound),this.shareToKill()):(this._yzMenu.setVisible(!0),this._roundUI.setSpriteFrame("ROUND"+this._curRound+".png"))},shareToKill:function(){this._yzMenu.removeFromParent(!0);
var a=new ShareUI;this.addChild(a,10,this.kTagShareUI);a.init()},piaoXue:function(a,b,c){a=new cc.LabelBMFont("-"+a,"res/Hurt.fnt",200,cc.TEXT_ALIGNMENT_LEFT);a.setScale(2);a.setPosition(b,c);b=new cc.MoveBy(1.5,0,200);b.easing(cc.easeSineOut());a.runAction(b);a.runAction(new cc.Sequence(new cc.FadeOut(1.6),new cc.CallFunc(a.removeFromParent,a)));this._clayer.addChild(a)},_logTfStrHistory:[],logToTf:function(a,b){this._logTfStrHistory.unshift(" - "+a.replace("\u3010\u968f\u673a\u503c\x3d\u4f24\u5bb3\u6570\u5b57\u3011",
b));2<this._logTfStrHistory.length&&this._logTfStrHistory.pop();this._tf.string=this._logTfStrHistory.join("\n")},onShared:function(){this.removeAllChildren();var a=cc.winSize,b=a.width/2,a=a.height/2;cc.spriteFrameCache.addSpriteFrames("res/Bishaji.plist");this._bishaji=new cc.Sprite("#bishaji/00.png");this._bishaji.setPosition(b,a);this._bishaji.setScale(Game.scaleAniBy);this.addChild(this._bishaji);b=new cc.Animate(getAnimation("bishaji/",23,0,10,1));this._lastDanmuY=0;this._bishaji.runAction(new cc.Sequence(b,
new cc.FadeOut(1),new cc.CallFunc(this.end,this)));this.schedule(this.endDanmu,0.5,DynamicData.endDanmu.length)},endDanmu:function(){DynamicData.endDanmu.length&&this.playDanMu(DynamicData.endDanmu.shift())},end:function(){var a=cc.winSize,b=a.width/2,c=a.height/2,d=new cc.LabelTTF("\u5e74\u517d\uff0c\u4f60\u8fd9\u662f\u81ea\u5bfb\u6b7b\u8def\uff01\n\u77ac\u95f4\u7206\u70b8\uff01\n\u95ee\u4f60\u6015\u4e0d\u6015\uff0c\u6211\u8fd9\u62db\u7528\u51fa\u6765\u6211\u81ea\u5df1\u90fd\u628a\u6301\u4e0d\u4f4f\u3002\n\u8d85\u795e\u4e94\u6740\u4e0d\u5728\u8bdd\u4e0b\n\u2026\u2026\u2026\u2026\n\u2026\u2026\u2026\u2026\n\u5c31\u662f\u6709\u70b9\u51fa\u529b\u8fc7\u731b\u554a\uff0c\u5934\u6709\u70b9\u6655\uff1f\n\u7cdf\u7cd5\uff0c\u773c\u775b\u770b\u4e0d\u6e05\u4e86\u2026\u2026\n\u2026\u2026\u2026\u2026\n\u2026\u2026\u2026\u2026\n\u53ef\u6076\uff0c\u96be\u9053\u6211\u5c31\u8981\u5012\u5728\u8fd9\u91cc\u4e86\u4e48\uff01\n\u545c\uff0c\u6211\u89c9\u5f97\u6211\u8fd8\u53ef\u4ee5\u62a2\u6551\u4e00\u4e0b\u554a\u2026\u2026",
"Arial",24);d.setHorizontalAlignment(cc.TEXT_ALIGNMENT_CENTER);d.setDimensions(0.8*a.width,0.8*a.height);d.setPosition(b,c);this.addChild(d);d.opacity=0;d.runAction(new cc.FadeIn(1));b=new cc.MenuItemImage("#jiejuBtn1.png","#jiejuBtn2.png",this.chakanJiejuClick,this);b.setPosition(0,0.1*-a.height);a=new cc.Menu(b);this.addChild(a);b.opacity=0;b.runAction(new cc.Sequence(new cc.DelayTime(0.5),new cc.FadeIn(1)))},chakanJiejuClick:function(){window.location.href=DynamicData.endURL}});cc.game.onStart=function(){!cc.sys.isNative&&document.getElementById("cocosLoading")&&document.body.removeChild(document.getElementById("cocosLoading"));cc.view.enableRetina(cc.sys.os===cc.sys.OS_IOS?!0:!1);cc.view.adjustViewPort(!0);cc.view.setDesignResolutionSize(540,960,cc.ResolutionPolicy.SHOW_ALL);cc.view.resizeWithBrowserSize(!0);cc.loaderScene=new CustomLoaderScene;cc.LoaderScene.preload(g_resources,function(){cc.spriteFrameCache.addSpriteFrames("res/ui.plist");cc.spriteFrameCache.addSpriteFrames(res.NianShouA_plist);
cc.spriteFrameCache.addSpriteFrames("res/YongZhe.plist");cc.spriteFrameCache.addSpriteFrames("res/Effect.plist");cc.director.runScene(new GameScene)},this)};cc.game.run();